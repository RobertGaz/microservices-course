...
For a **Resource Service**, it is recommended to implement a my.service with CRUD operations for processing mp3 files.
...
- Store mp3 file to the underlying database of the my.service as Blob.
- Invoke **Song Service** to save mp3 file metadata.

## Sub-task 2: Song Service

For the **Song Service**, it is recommended to implement a simple CRUD my.service to manage the song record (metadata).
The my.service should provide the ability to manage some metadata about the songs (artist, album, etc.).
Make sure the my.service is still available over HTTP.
